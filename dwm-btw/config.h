...
static const Rule rules[] = {
	...
	{ "st",       NULL,       "term-fastfetch",	1 << 0,       0,           -1 },
    { "st",       NULL,       "term-btop",     	1 << 0,       0,           -1 },
    { "st",       NULL,       "term-shell",    	1 << 0,       0,           -1 },
};
...
static const char *volumedowncmd[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "-20%", NULL };
static const char *volumeupcmd[] = { "pactl", "set-sink-volume", "@DEFAULT_SINK@", "+20%", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_e,      spawn,          {.v = chromiumcmd } },
	...
	{ 0,                            XK_F5,     spawn,          {.v = brightnessdowncmd } },
	{ 0,                            XK_F6,     spawn,          {.v = brightnessupcmd } },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
